...
1. Install the SFM3304 driver and all required packages as described in :ref:`Installation`.
...
4. Connect the SFM3304 sensor to the SEK-SensorBridge
5. Run the example script from the root of the repository.
   ...
   .. sourcecode:: bash
        ...
        python examples/example_usage_sensorbridge_sfm3304.py --serial-port <your COM port>
...
.. literalinclude:: ../examples/example_usage_sensorbridge_sfm3304.py
    :language: python
...
1. Install the SFM3304 driver and all required packages as described in :ref:`Installation`.
2. Connect the SFM3304 sensor to the I²C port of your system (for example to the I²C port 1 of a Raspberry Pi).
3. Run the example script from the root of the repository.
   ...
   .. sourcecode:: bash
      ...
      python examples/example_usage_linux_sfm3304.py --i2c-port <your I2C port>

Example script
~~~~~~~~~~~~~~

.. literalinclude:: ../examples/example_usage_linux_sfm3304.py
    :language: python
